...
O APK é de demonstração e o endpoint público pode ser temporário. Antes de enviar, confirme o health
do servidor, valide os hashes e copie estes mesmos arquivos para a pasta de entrega no Desktop.
