...
Na área adulta, cada uma das onze missões publicáveis agora mostra faixa de mediação, foco,
...
pseudônimo, selecionar uma das onze atividades e publicar a missão neste tablet; a Home passa a
