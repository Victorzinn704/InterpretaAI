...
| Adaptador OIDC | IMPLEMENTADO E TESTADO NO STAGING ORACLE | emissor RSA sintético em loopback + PostgreSQL Oracle: anônimo 401, professora 200 só na escola ativa, vínculo revogado oculto e Estúdio 302; fixtures removidas e staging restaurado para 403 | escolher provedor real, cadastrar cliente/callback e repetir com conta institucional |
