...
|---|---|---|---|
| `LearningStoryPack` e história da maçã | PRONTO PARA REVISÃO | schema + validador semântico + 6 mutações adversariais | produto, pedagogia e Android |
...
| Fontes do RAG | PRONTO PARA REVISÃO | 3 fontes próprias versionadas, manifesto e hashes; externas candidatas | curadores aprovarem próprias e fontes curriculares |
