...
| Recursos privados por hash | IMPLEMENTADO LOCALMENTE | arquivos ficam em `filesDir`, só entram por bytes e SHA-256 exatos, são deduplicados e passam por troca atômica | criar vínculo imutável versão → mídia sanitizada, rota privada e teste em aparelho com falta de espaço |
